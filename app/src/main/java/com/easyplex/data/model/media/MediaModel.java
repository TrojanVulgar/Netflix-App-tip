...
public class MediaModel implements Serializable {
    ...
    public static MediaModel media(@Nullable String videoid, @Nullable String substitleLang, @Nullable String currentQuality, String type, @Nullable String mediaName, @NonNull String videoUrl, @Nullable String artworkUrl,
                                   ...
                                   @Nullable String tvSeasonId, @Nullable String currentEpName, @Nullable String currentSeasonsNumber, Integer episodePostionNumber, String currentEpTmdbNumber , String isPremuim, String currentTvShowName) {
    ...
    public String getIsPremuim() {
        return isPremuim;
    }

    public void setIsPremuim(String isPremuim) {
        this.isPremuim = isPremuim;
    }
}
