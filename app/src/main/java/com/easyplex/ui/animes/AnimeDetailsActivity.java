...
import com.easyplex.data.model.anime.Anime;
...
public class AnimeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (anime != null){
            ...
            animeViewModel.animeDetailMutableLiveData.observe(this, animeDetail -> {
                ...
                onLoadSeasons(animeDetail.getSeasons(),animeDetail.getTmdbId());
                ...
                animeViewModel.isFavorite(Integer.parseInt(animeDetail.getTmdbId())).observe(this, favMovieDetail1 -> {
    ...
    private void onLoadSeasons(List<Season> seasons, String animeId) {
        ...
        binding.planetsSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mEPAdapter = new AnimesEpisodeAdapter(animeId,seasonNumber,episodeId,currentSeason);
