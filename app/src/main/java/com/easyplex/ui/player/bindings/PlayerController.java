 ...
 */
public class PlayerController extends BaseObservable implements TubiPlaybackControlInterface, Player.EventListener, SeekBar.OnSeekBarChangeListener {
    ...
    public final ObservableField<String> mediaPremuim = new ObservableField<>("");
    ...
    private void setModelMediaInfo(@NonNull MediaModel mediaModel, Context context) {
        ...
        if (!TextUtils.isEmpty(mMediaModel.getIsPremuim())) {
    ...
    @Override
    public Boolean isSubtitleEnabled(boolean enabled) {

        return isMediaSubstitleEnabled.get();
    ...
    @Override
    public String getCurrentMediaPremuim() {
